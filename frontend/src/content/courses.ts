import { inferLessonKind, normalizeCourseList, type CourseLesson, type CourseModule } from "@/types/course";

/** Keep in sync with backend/src/modules/courses/courses.seed.ts */
...
export const courses = normalizeCourseList(fallbackCourses);
