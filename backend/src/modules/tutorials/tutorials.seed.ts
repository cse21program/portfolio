import type { TutorialSection, TutorialWrite } from "./tutorials.types";

function section(
  title: string,
  summary: string,
  extra: Partial<TutorialSection> = {},
): TutorialSection {
  return {
    title,
    summary,
...
export const defaultTutorials: TutorialWrite[] = [
  {
    title: "Docker complete tutorial",
    slug: "docker-complete",
    description:
      "From images and containers to volumes, networking, Compose, and a deployable API stack — the same habits this site uses to run Postgres on 5433.",
    difficulty: "Beginner",
    prerequisites: ["A laptop you can install Docker Desktop on", "Comfort with a terminal"],
    duration: "4 hours",
    thumbnailUrl: null,
    skill: "Docker",
    ...
    free: true,
    sections: [
      section("Introduction", "Why containers, and what problem they actually solve.", {
        body: [
      ...
      section("Installation", "Docker Desktop and the CLI on macOS.", {
        body: [
        ...
        resources: [
          { label: "Docker Desktop for Mac", url: "https://docs.docker.com/desktop/setup/install/mac-install/" },
        ],
      }),
      section("Images", "Build context, layers, and tagging.", {
        body: [
      ...
      section("Containers", "Run, logs, exec, and lifecycle.", {
        body: [
      ...
      section("Volumes", "Keep Postgres data when the container dies.", {
        body: [
        ...
        resources: [
          { label: "Use volumes", url: "https://docs.docker.com/engine/storage/volumes/" },
        ],
      }),
      section("Networking", "Published ports versus service DNS.", {
        body: [
        ...
        resources: [
          { label: "Docker networking explained for API developers", url: "/blog/docker-networking" },
          { label: "Bridge networks", url: "https://docs.docker.com/engine/network/drivers/bridge/" },
        ],
      }),
      section("Dockerfile", "Multi-stage builds for Node and Java.", {
        body: [
      ...
      section("Compose", "API + Postgres with one command.", {
        body: [
        ...
        resources: [
          { label: "Compose specification", url: "https://docs.docker.com/reference/compose-file/" },
        ],
      }),
      section("Deployment", "Promote the same image you tested.", {
        body: [
        ...
        resources: [
          { label: "Production Docker course", url: "/courses/production-docker" },
        ],
      }),
    ],
    ...
    seoDescription:
      "Images, containers, volumes, networks, Compose, and a deployable API stack for backend developers.",
    canonicalUrl: "",
  },
  {
    ...
    description:
      "A practical layout for routes, controllers, services, and repositories in TypeScript — the seam this API already uses.",
    difficulty: "Intermediate",
    prerequisites: ["TypeScript", "Basic Express routing"],
    duration: "2 hours",
    thumbnailUrl: null,
    skill: "Node.js",
    relatedSkillSlugs: ["nodejs"],
    relatedCourseSlugs: [],
    price: "Free",
    free: true,
    sections: [
      section("Why modules", "Boundaries before frameworks.", {
        body: [
        ...
        resources: [
          { label: "Start with a modular monolith", url: "/blog/modular-monolith" },
        ],
      }),
      section("Folder layout", "One domain, one folder.", {
        body: [
      ...
      section("Error envelope", "Stable JSON errors.", {
        body: [
      ...
      section("Validation", "Zod at the edge.", {
        body: [
    ...
    seoDescription:
      "Routes, controllers, services, repositories, JSON errors, and Zod at the edge in TypeScript.",
    canonicalUrl: "",
  },
  {
    ...
    description:
      "Issue short-lived access tokens, rotate refresh tokens, and authorize every privileged action from the user record — not from claims the client sent.",
    difficulty: "Intermediate",
    prerequisites: ["Java", "REST APIs"],
    duration: "3 hours",
    thumbnailUrl: null,
    skill: "Spring Boot",
    relatedSkillSlugs: ["spring-boot", "java"],
    relatedCourseSlugs: ["spring-boot-masterclass"],
    price: "$29",
    free: false,
    sections: [
      section(
        "Why JWTs are not a permission system",
        "Claims are transport. Authorization still lives on the server.",
        {
          body: [
      ...
      section("Access tokens", "Keep them short-lived and boring.", {
        body: [
      ...
      section("Refresh rotation", "Rotate on use and reject reuse.", {
        body: [
      ...
      section("Spring Security wiring", "Filters, user lookup, and method security.", {
        body: [
      ...
      section("Tests you can keep", "Prove a forged claim cannot raise privileges.", {
        body: [
        ...
        resources: [
          { label: "Production-grade Spring Boot", url: "/courses/spring-boot-masterclass" },
        ],
      }),
    ],
    ...
    seoDescription:
      "Short-lived access tokens, refresh rotation, and authorization from the user record in Spring Security.",
    canonicalUrl: "",
  },
];
